...
dbLoadRecords("$(TOP)/db/redis.db","P=21:orange,S=stns.2,RRH=localhost,RRP=6379,RRDB=0,RWH=orange-2.ls-cat.net,RWP=6379,RWDB=0,pgHost=10.1.0.30,pgPort=5432,pgUser=lsuser,pgDb=ls")
